...
# Audio configuration
PRODUCT_COPY_FILES += \
    device/samsung/hlte-common/audio/snd_soc_msm_2x_Fusion3:system/etc/snd_soc_msm/snd_soc_msm_2x_Fusion3 \
...
ifeq ($(NEEDS_GPS_MSB_DISABLED),true)
    GPS_CONF := device/samsung/hlte-common/gps/gps-nomsb.conf
else
...
PRODUCT_COPY_FILES += device/samsung/hlte-common/bluetooth/bcm4335_prepatch.hcd:system/vendor/firmware/bcm4335_prepatch.hcd
